<template>
  <div class="bg-card p-2 pt-6 lg:p-6 text-foreground">
    ...
    <header class="mb-6">
      <h1 class="text-2xl font-bold tracking-tight mb-1">Pemesanan</h1>
      <p class="text-secondary text-sm">
        Pesan paket yang sesuai dengan kebutuhan bisnis anda.
      </p>
    </header>
    <div class="mb-20 lg:mb-0">
      <div class="flex flex-col lg:flex-row gap-8 lg:gap-12">
        ...
        <div class="flex-1 space-y-6 lg:space-y-8">
          <!-- 01. PONDASI WEBSITE -->
          <section
            class="bg-background shadow-app rounded-xl p-6 transition-all duration-300"
          >
        ...
        <aside class="hidden lg:block w-[360px] flex-shrink-0">
          <div
            class="sticky top-18 bg-background shadow-app rounded-xl p-6 shadow-sm"
          >
...
<style>
.rekapan::-webkit-scrollbar {
  width: 6px;
}

.rekapan::-webkit-scrollbar-track {
  background: transparent;
}

.rekapan::-webkit-scrollbar-thumb {
  background: var(--border);
  border-radius: 3px;
}

.rekapan::-webkit-scrollbar-thumb:hover {
